...
<h2 class="mb-4"><i class="bi bi-speedometer2 me-2"></i>ადმინ პანელი</h2>
...
<div class="row g-3 mb-4">
    <div class="col-6 col-md-3">
        <div class="card text-white bg-success p-3 text-center shadow-sm">
            ...
            <div class="small">სულ შემოსავალი</div>
        </div>
    </div>
    <div class="col-6 col-md-3">
    ...
    <div class="col-6 col-md-3">
        <div class="card text-white bg-info p-3 text-center shadow-sm">
            ...
            <div class="small">მომხმარებლები</div>
        </div>
    </div>
    <div class="col-6 col-md-3">
        <div class="card text-white bg-secondary p-3 text-center shadow-sm">
            <div class="fs-2 fw-bold"><?= $totalProducts ?></div>
            <div class="small">პროდუქტები</div>
        </div>
    </div>
</div>

<div class="row g-3 mb-4">
    <?php foreach ($statusLabels as $s => $label): $count = $statusCounts[$s] ?? 0; ?>
    <div class="col">
...
<div class="row g-4">
    <div class="col-lg-8">
        <div class="card shadow-sm">
            <div class="card-header d-flex justify-content-between align-items-center">
                <span class="fw-semibold">ბოლო შეკვეთები</span>
                <a href="/admin/orders.php" class="btn btn-sm btn-outline-secondary">ყველა</a>
            </div>
            <div class="card-body p-0">
                <table class="table table-hover mb-0 align-middle">
                    <thead class="table-light">
                        <tr><th>#</th><th>მომხმარებელი</th><th>პოზ.</th><th>სულ</th><th>სტატუსი</th><th>თარიღი</th></tr>
                    </thead>
                    <tbody>
    ...
    <div class="col-lg-4">
        <div class="card shadow-sm">
            <div class="card-header d-flex justify-content-between align-items-center">
                <span class="fw-semibold">მარაგი მცირეა</span>
                <a href="/admin/products.php" class="btn btn-sm btn-outline-secondary">ყველა პროდუქტი</a>
            </div>
            <?php if (empty($lowStock)): ?>
            <div class="card-body text-muted text-center py-4">ყველა პროდუქტი საკმარის მარაგშია.</div>
            <?php else: ?>
            <div class="card-body p-0">
                <table class="table table-hover mb-0 align-middle">
                    <thead class="table-light">
                        <tr><th>პროდუქტი</th><th class="text-end">მარაგი</th></tr>
                    </thead>
                    <tbody>
